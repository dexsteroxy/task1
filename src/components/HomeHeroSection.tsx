    ...
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          ...
          <svg width="100%" height="100%" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice">
            ...
            <defs>
              <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" style={{ stopColor: '#374151', stopOpacity: 0.3 }} />
      ...
      <div ref={contentRef} className="relative z-10 container mx-auto px-6">
        <div className="max-w-4xl">
          <h1 className="text-6xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
...
startups forward, fast, scalable, and built to adapt to the ever-changing digital
landscape.
          </p>
          ...
          <div className="trusted-logos">
            ...
            <div className="flex flex-wrap items-center gap-8">
              ...
              <div className="text-foreground/60 font-bold text-2xl">volkswagen</div>
